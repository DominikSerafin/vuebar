    ...
    Vuebar.install = function(Vue, options){
        ...
        function createState(el){
            el._vuebarState = {
                ...
                scrollHandler: null,
                wheelHandler: null,
                contentEditables: [], // current actived contentEditable Elements
            };
        ...
        function documentMouseup(el){
            ...
            return function(event){
                ...
                // enable stated actived contentEditable Element
                for (var item of state.contentEditables) {
        ...
        function barMousedown(el){
            ...
            return function(event){
                ...
                // disable actived contentEditable Element
                state.contentEditables = [];
                var contentEditableList = document.querySelectorAll("[contenteditable]");
                for (var item of contentEditableList) {
                  if ((document.activeElement == item || item.contains(document.activeElement)) && (item.contentEditable == true || item.contentEditable == "true")) {
                    state.contentEditables.push(item)
